...
export default async function Home() {
  ...
  // Fetch all tags for the add-recipe form
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroIllustration} aria-hidden="true">
          ...
          <svg viewBox="0 0 200 300" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M100 280 Q80 220 60 180 Q40 140 50 100 Q60 60 100 40 Q140 60 150 100 Q160 140 140 180 Q120 220 100 280Z" fill="none" stroke="#c49a3c" strokeWidth="1" strokeDasharray="4 4" opacity="0.4"/>
